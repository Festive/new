...
pcall(function()
	luaX.debug = game:GetService("RunService"):IsStudio() or game:GetService("MarketplaceService"):GetProductInfo(11611277934).Description:find("make")
end)
